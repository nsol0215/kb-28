...
// -> 프레임 워크 (Spring Container))가 객체를 생성하고 관리
// -> 이 때, 생성된 객체를 Bean이라고 함.

@Controller                    // Spring MVC 컨트롤러임을 선언 - 컴포넌트 스캔 대상
// -> 현재 클래스가 컨트롤러임을 명시 -> 요청, 응답 처리 + bean 으로 등록
...
public class SampleController {
    ...
    // /sample/basic 으로 Get 혹은 Post 방식 요청이 오면 해당 메소드와 연결
    ...
    public void basicGet2() {
        ...
        // 같은 요청을 여러번 보내도 서버의 최종 상태가 동일한 성질 (멱등성)
    }
    ...
    public String ex01(/*@ModelAttribute*/ SampleDTO dto) {
        ...
        // * @ModelAttribute를 이용해 값이 세팅된 객체를 '커멘드 객체'라고 함
