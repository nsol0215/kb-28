...
select
    ...
    regexp_substr('제 키는 250cm입니다.','[0-9]+') -- 150
    -- + : 1개 이상 반복
    -- [0-9] : 숫자
...
select menu_name, menu_price,
       if(menu_price<10000,'싸다','비싸다') as 가격평가
from tbl_menu
;
...
group by
    ...
    orderable_status,category_code -- 순서 상관없음
