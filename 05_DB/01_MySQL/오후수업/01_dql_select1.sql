...
-- OOO메뉴의 금액은 OOO원 입니다.
select
    concat(menu_name,'메뉴의 금액은',menu_price,'원 입니다.') as '메뉴설명'
from tbl_menu;
...
where
    ...
    # menu_price between 10000 and 20000 -- 가격이 10000원 이상 20000원 이하

    # menu_price <10000 or menu_price>20000 -- 가격이 10000원 미만 또는 20000원 초과
...
select * from tbl_menu
 order by
     ...
     # menu_price desc, menu_name asc -- 메뉴 가격 내림차순, 메뉴명 오름차순
     # menu_code asc, menu_name desc -- 메뉴 코드 오름차순, 메뉴명 내림차순
