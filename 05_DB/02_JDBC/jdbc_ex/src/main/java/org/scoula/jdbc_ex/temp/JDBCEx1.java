...
public class JDBCEx1 {
    public static void main(String[] args) {
        // JDBC : Java와 DB를 연결할 수 있게 해주는 API
        ...
        Statement stmt = null;
        // Connection 객체를 통해
        // Java에서 작성된 SQL을 DB로 전달하여 수행하 후
        ...
        try {
            ...
            // 1. DB 연결에 필요하나 MySQL JDBC Driver 메모리 로드하기
            ...
            // com.mysql.cj.jdbc.ConnectionImpl@72d1ad2e
